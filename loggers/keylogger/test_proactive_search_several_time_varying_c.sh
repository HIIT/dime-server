...
do
	...
	do 
		...
		python3 test_proactive_search_new.py --nostem --queries ../databases/20news-bydate-test/20news-bydate-test-3-cleaned-unsorted2.txt --querypath ../databases/20news-bydate-test --numwords 50 --removeseenkws --nwritten $nwritten --nclicked 10:2 --c $c --dime_search_method 3 20news --knownitem
