...
plt.plot(np.arange(10,21), clicka1[ 9:20], linewidth=4, c='g', label='lambda = 1')
...
plt.plot(np.arange(10,21), clickb1[ 9:20], linewidth=4, c='r', label='lambda = 0.75')
...
plt.plot(np.arange(10,21), clickc1[ 9:20], linewidth=4, c='c', label='lambda = 0.50')
...
plt.plot(np.arange(10,21), clickd1[ 9:20], linewidth=4, c='m', label='lambda = 0.25')
