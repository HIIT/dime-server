...
plt.plot(np.arange(1,31), clicka0[0:30], linewidth=6, label='cont-old')
plt.plot(np.arange(1,41), clicka1[0:40], linewidth=6, label='cont-old')
plt.plot(np.arange(1,51), clicka2[0:50], linewidth=6, label='cont-old')
