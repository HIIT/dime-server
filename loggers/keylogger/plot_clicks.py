...
ax0.plot(np.arange(1,51), upper_baseline, linewidth=3, label='baseline')
ax0.yaxis.set_ticks(np.arange(0.2, 1.1, 0.2))
ax0.set_title('documents')
ax0.axis([0, 50, 0.2, 1.0])
ax0.grid(True)

ax1.plot(np.arange(1,51), lower_baseline, linewidth=3, label='baseline')
ax1.yaxis.set_ticks(np.arange(0, 0.55, 0.1))
ax1.set_title('keywords')
ax1.axis([0, 50, 0, 0.50])
ax1.grid(True)
